...
gometalinter --vendor --deadline 1m --enable-gc --disable-all $enabledLinters --exclude=vendor --exclude="should not use dot imports" --exclude="can be annoying to use" --exclude=$filesToExclude ./...
