...
var networkservicesResource = schema.GroupVersionResource{Group: "sfccontroller.ligato.github.com", Version: "v1alpha1", Resource: "networkservices"}

var networkservicesKind = schema.GroupVersionKind{Group: "sfccontroller.ligato.github.com", Version: "v1alpha1", Kind: "NetworkService"}
...
func (c *FakeNetworkServices) List(opts v1.ListOptions) (result *v1alpha1.NetworkServiceList, err error) {
	...
	list := &v1alpha1.NetworkServiceList{}
...
func (c *FakeNetworkServices) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.NetworkService, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(networkservicesResource, c.ns, name, data, subresources...), &v1alpha1.NetworkService{})
