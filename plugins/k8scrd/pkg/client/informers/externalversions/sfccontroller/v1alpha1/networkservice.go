	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.SfccontrollerV1alpha1().NetworkServices(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.SfccontrollerV1alpha1().NetworkServices(namespace).Watch(options)
			},
		},
		&sfccontroller_v1alpha1.NetworkService{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *networkServiceInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&sfccontroller_v1alpha1.NetworkService{}, f.defaultInformer)
}
